...
fun DownloadableSurveys(
    ...
    Scaffold(
        ...
        val lista = downloadSurveyViewModel.surveys
            ...
            Button(
                ...
                onClick = {
                    selectedSurvey?.let { survey ->
                        downloadSurveyViewModel.downloadSurvey(context = context, survey = survey, id = id)
                        Toast.makeText(context, "Encuesta descargada", Toast.LENGTH_SHORT).show()
                        context.finish()
                    } ?: Toast.makeText(context, "Seleccione una encuesta primero", Toast.LENGTH_SHORT).show()
            }) {
